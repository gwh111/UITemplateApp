...
#import "UITextView+CCCover.h"
#import "UIBezierPath+CCCover.h"
#import <objc/message.h>

@implementation UITextView (CCCover)
...
- (UIBezierPath *)cc_defaultCoverablePath {
    return [UIBezierPath multiLinePath:self.numberOfVisibleLines spacing:self.linespacing bounds:self.bounds];
}
