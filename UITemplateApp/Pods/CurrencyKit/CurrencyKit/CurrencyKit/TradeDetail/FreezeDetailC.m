...
@interface FreezeDetailC ()

@property (nonatomic, retain) CC_TableView *tableView;
@property (nonatomic, assign) int currentPage;
@property (nonatomic, retain) NSString *startDate;
@property (nonatomic, retain) NSString *endDate;
@property (nonatomic, retain) NSMutableArray *freezeList;

@end

@implementation FreezeDetailC
...
- (void)updateFreezeDetail {
    ...
    if (_currentPage == 1) {
        ...
        _freezeList = ccs.mutArray;
    }
    [ccs.accountLib_freeze freezePageQueryWithCurrentPage:_currentPage endDate:_endDate pageSize:20 startDate:_startDate success:^(HttpModel * _Nonnull result) {
        
        [self.freezeList addObjectsFromArray:result.resultDic[@"freezeInfoSimples"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FreezeDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[FreezeDetailTableViewCell alloc]
    ...
    [cell update:_freezeList[indexPath.row]];
